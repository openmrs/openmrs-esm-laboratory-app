"use strict";
(globalThis["webpackChunk_ugandaemr_esm_laboratory_app"] = globalThis["webpackChunk_ugandaemr_esm_laboratory_app"] || []).push([["vendors-node_modules_rxjs__esm5_internal_operators_map_js"],{
...
/** PURE_IMPORTS_START tslib,_util_isFunction,_Observer,_Subscription,_internal_symbol_rxSubscriber,_config,_util_hostReportError PURE_IMPORTS_END */ function _instanceof(left, right) {
        ...
        switch(arguments.length){
            ...
            case 1:
                ...
                if (typeof destinationOrNext === "object") {
                    if (_instanceof(destinationOrNext, Subscriber)) {
...
var SafeSubscriber = /*@__PURE__*/ function(_super) {
    var SafeSubscriber = function SafeSubscriber(_parentSubscriber, observerOrNext, error, complete) {
        var _this = _super.call(this) || this;
...
/** PURE_IMPORTS_START _util_isArray,_util_isObject,_util_isFunction,_util_UnsubscriptionError PURE_IMPORTS_END */ function _instanceof(left, right) {
    if (right != null && typeof Symbol !== "undefined" && right[Symbol.hasInstance]) {
        return !!right[Symbol.hasInstance](left);
    } else {
        return left instanceof right;
...
var Subscription = /*@__PURE__*/ function() {
    ...
    Subscription.prototype.unsubscribe = function() {
        ...
        this._parentOrParents = null;
        this._subscriptions = null;
        if (_instanceof(_parentOrParents, Subscription)) {
        ...
        if ((0,_util_isFunction__WEBPACK_IMPORTED_MODULE_0__.isFunction)(_unsubscribe)) {
            ...
            try {
                ...
                errors = _instanceof(e, _util_UnsubscriptionError__WEBPACK_IMPORTED_MODULE_1__.UnsubscriptionError) ? flattenUnsubscriptionErrors(e.errors) : [
                    e
                ];
            }
        }
            ...
            while(++index < len){
                ...
                if ((0,_util_isObject__WEBPACK_IMPORTED_MODULE_3__.isObject)(sub)) {
                    try {
                        ...
                        errors = errors || [];
                        if (_instanceof(e, _util_UnsubscriptionError__WEBPACK_IMPORTED_MODULE_1__.UnsubscriptionError)) {
    ...
    Subscription.prototype.add = function(teardown) {
        ...
        switch(typeof teardown === "undefined" ? "undefined" : _type_of(teardown)){
            case "function":
            ...
            case "object":
                if (subscription === this || subscription.closed || typeof subscription.unsubscribe !== "function") {
                    ...
                    return subscription;
                } else if (!_instanceof(subscription, Subscription)) {
        ...
        } else if (_instanceof(_parentOrParents, Subscription)) {
...
function flattenUnsubscriptionErrors(errors) {
    return errors.reduce(function(errs, err) {
        return errs.concat(_instanceof(err, _util_UnsubscriptionError__WEBPACK_IMPORTED_MODULE_1__.UnsubscriptionError) ? err.errors : err);
    }, []);
...
var MapSubscriber = /*@__PURE__*/ function(_super) {
    var MapSubscriber = function MapSubscriber(destination, project, thisArg) {
...
/** PURE_IMPORTS_START  PURE_IMPORTS_END */ var UnsubscriptionErrorImpl = /*@__PURE__*/ function() {
    var UnsubscriptionErrorImpl = function UnsubscriptionErrorImpl(errors) {
        Error.call(this);
...
//# sourceMappingURL=vendors-node_modules_rxjs__esm5_internal_operators_map_js.js.map