"use strict";
(globalThis["webpackChunk_ugandaemr_esm_laboratory_app"] = globalThis["webpackChunk_ugandaemr_esm_laboratory_app"] || []).push([["vendors-node_modules_react-router-dom_dist_index_js"],{
...
var AbortedDeferredError = /*#__PURE__*/ function(Error1) {
    ...
    var _super = _create_super(AbortedDeferredError);
 ...
 */ function createRouter(init) {
    ...
    function _navigate() {
        ...
        _async_to_generator(function(to, opts) {
    ...
    function _startNavigation() {
        ...
        // navigation
        _async_to_generator(function(historyAction, location, opts) {
    ...
    function _handleAction() {
        ...
        // redirects/errors
        _async_to_generator(function(request, location, submission, matches, opts) {
    ...
    function _handleLoaders() {
        ...
        // errors, etc.
        _async_to_generator(function(request, location, matches, overrideNavigation, submission, fetcherSubmission, replace, pendingActionData, pendingError) {
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        routesToUse = inFlightDataRoutes || dataRoutes;
                        _getMatchesToLoad = _sliced_to_array(getMatchesToLoad(init.history, state, matches, activeSubmission, location, isRevalidationRequired, cancelledDeferredRoutes, cancelledFetcherLoads, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, pendingActionData, pendingError), 2), matchesToLoad = _getMatchesToLoad[0], revalidatingFetchers = _getMatchesToLoad[1];
    ...
    function _handleFetcherAction() {
        ...
        _async_to_generator(function(key, routeId, path, match, requestMatches, submission) {
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    ...
                    case 1:
                        ...
                        _getMatchesToLoad = _sliced_to_array(getMatchesToLoad(init.history, state, matches, submission, nextLocation, isRevalidationRequired, cancelledDeferredRoutes, cancelledFetcherLoads, fetchLoadMatches, fetchRedirectIds, routesToUse, basename, _define_property({}, match.route.id, actionResult.data), undefined // No need to send through errors since we short circuit above
    ...
    function _handleFetcherLoader() {
        ...
        _async_to_generator(function(key, routeId, path, match, matches, submission) {
   ...
   */ _async_to_generator(function(state, redirect, _temp) {
            var _ref, submission, replace, isFetchActionRedirect, redirectLocation, isDocumentReload, url, redirectHistoryAction, activeSubmission, overrideNavigation;
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    case 0:
                        ...
                        redirectLocation = createLocation(state.location, redirect.location, _extends({
                            _isRedirect: true
                        ...
                        activeSubmission = submission || getSubmissionFromNavigation(state.navigation);
    ...
    function _callLoadersAndMaybeResolveData() {
        _callLoadersAndMaybeResolveData = _async_to_generator(function(currentMatches, matches, matchesToLoad, fetchersToLoad, request) {
                ...
                switch(_state.label){
                    case 0:
                        return [
                            ...
                            })).concat(_to_consumable_array(fetchersToLoad.map(function(f) {
...
function createStaticHandler(routes, opts) {
   ...
   * return it directly.
   */ _async_to_generator(function(request, _temp2) {
            ...
            return _ts_generator(this, function(_state) {
                switch(_state.label){
                    ...
                    case 3:
                        ...
                        return [
                            4,
                            loadRouteData(request, matches, requestContext, undefined, _define_property({}, boundaryMatch.route.id, result.error))
                        ];
                    case 4:
                        context = _state.sent();
 ...
 */ _async_to_generator(function(route, mapRouteProperties, manifest) {
...
function _callLoaderOrAction() {
    _callLoaderOrAction = _async_to_generator(function(type, request, match, matches, manifest, mapRouteProperties, basename, opts) {
        var resultType, result, onReject, runHandler, handler, values, url, pathname, url1, pathname1, e, status, location, currentUrl, url2, isSameBasename, queryRouteResponse, data, contentType, _result$init, _result$init2;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
                    if (opts === void 0) {
...
function _resolveDeferredResults() {
    _resolveDeferredResults = _async_to_generator(function(currentMatches, matchesToLoad, results, signals, isFetcher, currentLoaderData) {
        var _loop, index;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
...
function _resolveDeferredData() {
    _resolveDeferredData = _async_to_generator(function(result, signal, unwrap) {
        var aborted;
        return _ts_generator(this, function(_state) {
            switch(_state.label){
                case 0:
...
function getFormSubmissionInfo(target, basename) {
    ...
    if (isFormElement(target)) {
        ...
        action = attr1 ? (0,react_router__WEBPACK_IMPORTED_MODULE_1__.stripBasename)(attr1, basename) : null;
    ...
    if (typeof to === "string" && ABSOLUTE_URL_REGEX.test(to)) {
        ...
        if (isBrowser) {
            try {
                ...
                var path = (0,react_router__WEBPACK_IMPORTED_MODULE_1__.stripBasename)(targetUrl.pathname, basename);
 ...
 */ var NavLink = /*#__PURE__*/ react__WEBPACK_IMPORTED_MODULE_0__.forwardRef(function NavLinkWithRef(_ref5, ref) {
    ...
    var navigator = react__WEBPACK_IMPORTED_MODULE_0__.useContext(react_router__WEBPACK_IMPORTED_MODULE_2__.UNSAFE_NavigationContext).navigator;
 ...
 */ function usePrompt(_ref8) {
    ...
    var blocker = (0,react_router__WEBPACK_IMPORTED_MODULE_2__.unstable_useBlocker)(when);
    react__WEBPACK_IMPORTED_MODULE_0__.useEffect(function() {
...
function useNavigateUnstable() {
    ...
    var routePathnamesJson = JSON.stringify((0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__.UNSAFE_getPathContributingMatches)(matches).map(function(match) {
...
var RenderErrorBoundary = /*#__PURE__*/ function(_React_Component) {
    ...
    var _super = _create_super(RenderErrorBoundary);
 ...
 */ function useMatches() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.useMemo(function() {
        return matches.map(function(match) {
            var pathname = match.pathname, params = match.params;
 ...
 */ function Navigate(_ref4) {
    ...
    var path = (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__.resolveTo)(to, (0,_remix_run_router__WEBPACK_IMPORTED_MODULE_1__.UNSAFE_getPathContributingMatches)(matches).map(function(match) {
        return match.pathnameBase;
...
var AwaitErrorBoundary = /*#__PURE__*/ function(_React_Component) {
    ...
    var _super = _create_super(AwaitErrorBoundary);
