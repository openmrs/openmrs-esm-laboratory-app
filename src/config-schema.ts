...
const allowedLabTableColumns = ['name', 'urgency', 'age', 'dob', 'sex', 'totalOrders', 'action', 'patientId'] as const;
...
export const configSchema = {
  ...
  labTableColumns: {
    _type: Type.Array,
    _default: ['name', 'urgency', 'age', 'sex', 'totalOrders', 'action'] as Array<LabTableColumnName>,
