...
export class PatientListsPage {
  ...
  readonly allListsButton = () =>
    this.page.getByRole("tab", { name: "All lists" });
  ...
  async addNewPatientList(listName: string, description: string) {
    ...
    await this.page
      .getByLabel("Describe the purpose of this list in a few words")
      .fill(description);
  ...
  async editPatientList(listName: string, description: string) {
    ...
    await this.page
      .getByRole("menuitem", { name: "Edit name or description" })
      .click();
    await this.page.getByLabel("List name").fill(listName);
    await this.page
      .getByLabel("Describe the purpose of this list in a few words")
  ...
  async deletePatientList() {
    await this.page.getByRole("button", { name: "Actions" }).click();
    await this.page
      .getByRole("menuitem", { name: "Delete patient list" })
      .click();
  }
}
